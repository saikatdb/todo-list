...
const completed = createProject('completed');
...
//create the task
const taskFactory = (title, detail, date, complete, imp) => {
  const dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(date), 'MM/dd/yyyy');
  return { title, detail, dueDate, complete, imp };
};
...
let task1 = (0,_creatingTask__WEBPACK_IMPORTED_MODULE_0__.taskFactory)(
  'finished project',
  '',
  '2023, 10, 5',
  'no',
