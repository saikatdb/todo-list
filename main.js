...
const deleteProject = () => {
  ...
  projectList.addEventListener('click', (event) => {
    if (event.target.classList.contains('delete')) {
      ...
      console.log(_creatingProject__WEBPACK_IMPORTED_MODULE_0__.defaultProjectList);
...
/* harmony export */   "removeAllProject": () => (/* binding */ removeAllProject),
